...
func main() {
	...
	if err == nil {
		...
		productInvoices := api.NewProductInvoice(restrictedPath)
		productInvoices.GetProductInvoices()
		productInvoices.GetProductInvoiceById()
		productInvoices.AddProductInvoice()
		productInvoices.UpdateProductInvoice()
		productInvoices.DeleteProductInvoice()
		productInvoices.GetInvoiceItemsById()
		productInvoices.AddInvoiceItem()
