                        ...
                        <div className="p-grid">
                            <div className="p-col p-fluid" style={{padding:'.5em'}}>
                                <DataTable value={this.state.payments} paginator={true} rows={25}
                                    ...
                                    <Column field="amount" header={this.props.type === 'customer' ? 'Received Amount' : 'Paid Amount'} sortable={false} style={{textAlign: 'right'}}/>
                                    <Column field="remaining" header={this.props.type === 'customer' ? 'Receivable Amount' : 'Payable Amount'} sortable={false} style={{textAlign: 'right'}}/>
                                    <Column field="total" header="Total Amount" sortable={true} style={{textAlign: 'right'}}/>
